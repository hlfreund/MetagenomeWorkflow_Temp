...
do
    ...
    if [[ ! -f ./${SAMPLE}_contigs_unsort.bam ]]; then
        ...
        mv ${SAMPLE}_contigs_unsort.bam ${SAMPLE}_contigs_sorted.bam ${SAMPLE}_contigs_stats.tsv ${SAMPLE}_contigs_coverage.tsv ${SAMPLE}_contigs_depth.tsv ./BWA_Map_to_Contigs/
