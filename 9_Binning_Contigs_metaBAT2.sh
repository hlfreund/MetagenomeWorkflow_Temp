...
do
    ...
    runMetaBat.sh -t 4 -m 1500 SSD_Contigs_CleanName.fa ${SAMPLE}_contigs_sorted.bam -o ${SAMPLE}_bin
    #runMetaBat.sh -t 4 -m 1500 ${SAMPLE}_contigs.fasta ${SAMPLE}_contigs_sorted.bam
    
    mv ${SAMPLE}_bin.metabat-bins1500 ${SAMPLE}_bins_metabat
...
do
    ...
    metabat2 -i SSD_Contigs_CleanName.fa -a {SAMPLE}_contigs_depth.txt -o ./${SAMPLE}_bins
    #runMetaBat.sh -t 4 -m 1500 ${SAMPLE}_contigs.fasta ${SAMPLE}_contigs_sorted.bam
